...
<div class="flex justify-between items-center h-16 bg-gray-100 selection:bg-red-500 selection:text-white">
    <div class="text-2xl p-5">One to One</div>
    @if (Route::has('login'))
...
<div class="container mx-auto my-3 px-2">
    @yield('content')
</div>
